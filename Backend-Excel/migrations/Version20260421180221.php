 ...
 */
final class Version20260421180221 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE acceso (id INT AUTO_INCREMENT NOT NULL, permiso INT NOT NULL, user_id INT NOT NULL, fichero_id INT NOT NULL, INDEX IDX_1268771BA76ED395 (user_id), INDEX IDX_1268771B8E05855 (fichero_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE fichero (id INT AUTO_INCREMENT NOT NULL, nombre VARCHAR(20) NOT NULL, descripcion VARCHAR(50) DEFAULT NULL, data JSON NOT NULL, fecha_creacion DATETIME NOT NULL, fecha_mod DATETIME NOT NULL, ultima_subida_id INT NOT NULL, tipo_fichero_id INT NOT NULL, INDEX IDX_F4E944343336E21D (ultima_subida_id), INDEX IDX_F4E9443499665A7D (tipo_fichero_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
